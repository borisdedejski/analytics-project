...
export const MetricFindFirstOrThrowArgsSchema: z.ZodType<Omit<Prisma.MetricFindFirstOrThrowArgs, "select" | "include">> = z.object({
...
export default MetricFindFirstOrThrowArgsSchema;
